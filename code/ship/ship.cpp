 ...
 *
 * Revision 2.336.2.75  2007/09/02 02:07:46  Goober5000
 * added fixes for #1415 and #1483, made sure every read_file_text had a corresponding setjmp, and sync'd the parse error messages between HEAD and stable
 *
 * Revision 2.336.2.74  2007/08/11 16:51:56  Goober5000
 ...
 *
 * Revision 2.336.2.64  2007/05/17 14:58:40  taylor
 ...
 * use VALID_FNAME()
 *
 * Revision 2.336.2.55  2007/02/11 06:19:08  Goober5000
 ...
 *
 * Revision 2.336.2.38  2006/10/27 06:42:29  taylor
 ...
 * fix forum links
 *
 * Revision 2.336.2.35  2006/10/06 15:12:55  karajorma
 * Fix for Mantis 1092 - (Support ships damage hull)
 *
 * Revision 2.336.2.34  2006/10/06 09:47:10  taylor
 ...
 * Another typo
 *
 * Revision 2.336.2.22  2006/08/09 17:39:46  karajorma
 ...
 * --Goober5000
 *
 * Revision 2.336.2.17  2006/07/20 00:41:26  Goober5000
 ...
 * --Goober5000
 *
 * Revision 2.336.2.14  2006/07/09 06:12:37  Goober5000
 * bah, make sure we're in the correct mode
 *
 * Revision 2.336.2.13  2006/07/09 06:07:20  Goober5000
 ...
 * --Goober5000
 *
 * Revision 2.336.2.8  2006/07/06 04:06:01  Goober5000
 ...
 * --Goober5000
 *
 * Revision 2.336.2.7  2006/07/05 23:36:56  Goober5000
 * cvs comment tweaks
 *
 * Revision 2.336.2.6  2006/07/04 07:42:10  Goober5000
 ...
 * --Goober5000
 *
 * Revision 2.336.2.5  2006/06/27 04:06:17  Goober5000
 * handle docked objects during death roll
 * --Goober5000
 *
 * Revision 2.336.2.4  2006/06/24 20:39:57  wmcoolmon
...
ship::ship() : warpin_effect(NULL), warpout_effect(NULL), shield_integrity(NULL), ship_replacement_textures(NULL)
{
	...
	for(size_t i = 0; i < MAX_SHIP_CONTRAILS; ++i)
	{
	...
	desc(NULL), tech_desc(NULL), ship_length(NULL), gun_mounts(NULL), missile_banks(NULL), subsystems(NULL)
{
	...
	ispew_max_particles = 0;
	dspew_max_particles = 0;
...
strcpy(parse_error_text, temp_error);
	...
	if ( n_subsystems > 0 ) {
		if(sip->n_subsystems < 1) {
			...
			sip->subsystems = new(vm_malloc(sizeof(model_subsystem) * sip->n_subsystems )) model_subsystem[sip->n_subsystems];
		} else {
			sip->n_subsystems += n_subsystems;
			sip->subsystems = new(vm_realloc(sip->subsystems, sizeof(model_subsystem) * sip->n_subsystems)) model_subsystem[sip->n_subsystems];
		} 
...
static void ship_allocate_subsystems(int num_so, bool page_in = false)
{
	...
	do {
		...
		Ship_subsystems[idx] = new(vm_malloc( sizeof(ship_subsys) * NUM_SHIP_SUBSYSTEMS_PER_SET )) ship_subsys[NUM_SHIP_SUBSYSTEMS_PER_SET];
	...
	for ( i = 0; i < Num_ship_classes; i++ ) {
		if ( Ship_info[i].subsystems != NULL ) {
			for(n = 0; n < Ship_info[i].n_subsystems; n++) {
				...
				Ship_info[i].subsystems->~model_subsystem();
			}
