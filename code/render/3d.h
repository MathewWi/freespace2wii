...
#else
#define g3_start_frame(zbuffer_flag)  g3_start_frame_func(zbuffer_flag)
extern void g3_start_frame_func(int zbuffer_flag);
#define g3_end_frame() g3_end_frame_func()
extern void g3_end_frame_func();
#endif
